...
/**
 * Screen Labels & Process Generator
 * Compatible with Adobe Illustrator CC
 */
...
(function generateScreenLabelsUI() {
    ...
    // --- 2. AUTO-CORRECT UNDERLY BASE SWATCH (X PROCESS ONLY) ---
    if (hasUnderlyBase) {
        ...
        if (underlySwatch) {
            ...
            if (oldSwatchName.indexOf(expectedUnderlyPrefix) !== 0) {
                ...
                noticeMsg += "=========================================\n\n";
                noticeMsg += "Process selected: X" + selectedVal + " (SCREEN ." + underlyScreenNum + " is Underly Base)\n\n";
    ...
    // --- HELPER 3: PARSE INITIAL & COLOUR NAME (STRIP (MUTE), (TRICK), ETC.) ---
